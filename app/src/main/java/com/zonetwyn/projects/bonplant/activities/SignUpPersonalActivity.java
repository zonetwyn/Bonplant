...
import com.zonetwyn.projects.bonplant.fragments.SignUpPersonalFragment;
import com.zonetwyn.projects.bonplant.fragments.SignUpProfileFragment;
import com.zonetwyn.projects.bonplant.fragments.SignUpProfileUpdatedFragment;
...
public class SignUpPersonalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbarTitle.setText(R.string.personal_title);
    ...
    private class PageAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                ...
                case 1:
                    return new SignUpProfileUpdatedFragment();
            }
            return null;
        }
